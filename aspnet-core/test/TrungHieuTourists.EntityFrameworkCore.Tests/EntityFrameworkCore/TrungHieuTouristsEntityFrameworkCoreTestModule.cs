...
[DependsOn(
    ...
    typeof(TrungHieuTouristsTestBaseModule),
...
public class TrungHieuTouristsEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var options = new DbContextOptionsBuilder<TrungHieuTouristsDbContext>()
            .UseSqlite(connection)
            .Options;

        using (var context = new TrungHieuTouristsDbContext(options))
        {
